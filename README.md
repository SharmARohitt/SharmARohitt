...
<h1 align="center">Hey, I'm Rohit Sharma</h1>
 

I’m a software engineer focused on building scalable backend systems, data-driven platforms, and applied AI solutions with real-world impact.

I care deeply about system design, clean architecture, and engineering rigor building software that is reliable, understandable, and built to scale. My work spans backend services, ETL-style data pipelines, AI-powered applications, and decentralized systems.

I’ve shipped under real constraints (government, production, hackathons) and value environments where **engineering quality and long-term thinking matter**.

---

### Core Focus
- **Backend Engineering** — APIs, microservices, system design (Node.js, Python, Go)
- **Data & ETL Systems** — structured pipelines, transformations, reliability
- **AI Engineering** — NLP, CV, applied ML, GenAI use-cases
- **Web3 & Blockchain** — smart contracts, dApps, protocol-level thinking
